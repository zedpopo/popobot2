...
module.exports = msgHandler = async (client = new Client(), message) => {
    try {
            ...
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                */
                ...
                client.sendStickerfromUrl(from, url).then((r) => (!r && r !== undefined)
                    ...
                    : client.reply(from, 'Here\'s your sticker! jangan lupa follow @apocalypsegod_')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
            } else {
        ...
        case 'facebook':
            ...
            await client.reply(from, '_Scraping Metadata..._ \n\nTerimakasih telah menggunakan POPOBOT , kamu dapat membantu pengembangan bot ini dengan follow instagram saya @apocalypsegod_ \nTerimakasih.', id)
